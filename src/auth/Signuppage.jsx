      ...
      <div className="min-h-screen flex flex-col justify-center items-center w-full">
        <div className="w-[90%] relative md:w-[70%] bg-[#F1F1F1] pt-[30px] pb-[30px] rounded-[20px] flex flex-col justify-center items-center gap-5">
          ...
          <div className="w-[90%] md:w-[60%] flex gap-2 flex-col justify-center items-center">
            ...
            <div className="w-full flex flex-row justify-start items-center">
              <input
                ...
                id="terms"
              />
              <span className="underline font-light ml-2">
                Terms & Conditions
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-[90%] md:w-[60%] py-3 rounded-[10px] bg-[#ffe001] text-lg font-semibold text-white"
          >
            Sign Up
          </button>

          <Link to="/auth">
            <p className="text-center text-md font-light underline">
