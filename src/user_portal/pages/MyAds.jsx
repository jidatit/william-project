		...
		try {
			...
			for (const img of deletedImagesFromStorage) {
				const imageName = decodeURIComponent(
					img.file.file.split("?")[0].split("/o/")[1],
				);
			...
			currentImages = currentImages.filter(
				(img) =>
					!deletedImages.some((deletedImg) => deletedImg.file === img.file),
			);
			...
			<div className="w-[80%] min-h-screen flex flex-col justify-start items-center">
				...
				<div className="w-full mt-[20px] mb-[20px] flex flex-col justify-center items-start">
					<div
						...
						className="lg:w-[20%] w-full transition-all ease-in-out delay-150 cursor-pointer hover:bg-[#ffe001] hover:text-white rounded-[30px] border-[2px] border-[#ffe001] text-[#ffe001] font-semibold px-2 py-3"
					>
				...
				<div className="w-full mt-[20px] mb-[20px] flex flex-col justify-center items-center">
					<div className="flex w-full flex-col lg:flex-row gap-2">
						<div className="lg:w-[20%] w-full rounded-[30px] cursor-pointer bg-[#ffe001] text-white font-semibold px-2 py-3">
							<p className="text-center">Active</p>
						</div>
						<div className="lg:w-[20%] w-full transition-all ease-in-out delay-150 cursor-pointer hover:bg-[#ffe001] hover:text-white rounded-[30px] border-[2px] border-[#ffe001] text-[#ffe001] font-semibold px-2 py-3">
					...
					<div className="md:w-[50%] w-[90%] mt-[50px] gap-4 bg-white flex flex-col rounded-md shadow-lg overflow-y-auto max-h-[80vh] items-center py-[30px]">
						...
						<div className="w-[90%] mb-5 flex flex-col justify-end items-end">
							<div className="md:w-[30%] w-full pr-0 md:pr-2">
								<Button
									onClickProp={
										createButtonText === "Create" ? createAd : updateAd
									}
