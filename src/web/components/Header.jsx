		...
		<>
			<nav className="w-full sticky top-0 z-40 bg-[#000000]">
				<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
						...
						{!currentUser ? (
							<>
								<Link className="w-full" to="/auth/signup">
									<button className="text-white flex flex-col justify-center items-center hover:scale-105 bg-[#ffe001] outline-none font-medium rounded-lg text-sm px-4 py-2">
										Signup
									</button>
								</Link>
								<Link className="w-full" to="/auth">
									<button className="text-white flex flex-col justify-center items-center  bg-[#ffe001] outline-none font-medium rounded-lg text-sm px-4 py-2">
										Login
									</button>
								</Link>
							</>
							...
							<>
								...
								<button
									className="text-white flex flex-col justify-center items-center hover:scale-105 bg-red-700 outline-none font-medium rounded-lg text-sm px-4 py-2"
									onClick={logout}
								>
									logout
								</button>
					...
					{
						<div
							className={`items-center justify-between ${openHam ? "block" : "hidden"} w-full md:flex md:w-auto md:order-1`}
							id="navbar-cta"
						>
							<ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
								<Link to="/">
									<li>
										<p className="block py-2 px-3 md:p-0 text-white  rounded md:bg-transparent">
											Home
										</p>
									</li>
								</Link>
								...
								<li>
									<Link to="/auth">
										<p className="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent  dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
											For Sellers
										</p>
									</Link>
								</li>
